...
public class FloatingTextManager : MonoBehaviour
{
    ...
    public static void CreateFloatingText(Transform transform, string text, Color? color = null, Color? outlineColor = null)
    {
        var instance = Instantiate(_floatingTextObject);
        instance.transform.position = transform.position + Vector3.up * 3.0f;
